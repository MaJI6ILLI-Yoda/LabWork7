...
function mousemoveHandler(e){
  ...
  if( e.clientX - 40 > rect.left )
    mygun.style.left = e.clientX - rect.left - 40  + "px";
  else 
    mygun.style.left = 0 + "px";
  
  
  if( e.clientX + 40  > rect.right )
    mygun.style.left = rect.width - 84 + "px";
}
...
function enemyMove(){
  ...
  enemy.style.left = i + "px";
   ...
   if( i + 80 >  rect.width ){
    enemy.style.left = rect.width - 84  + "px";
    flag = "left" ;
   }  
